function php_refactoring_toolbox#vim#begin_ftplugin(name)
    call s:checkFileTypePluginIsLoadedOnce(a:name)

    call php_refactoring_toolbox#vim#begin_script()
endfunction

function php_refactoring_toolbox#vim#end_ftplugin()
    call php_refactoring_toolbox#vim#end_script()
endfunction

function php_refactoring_toolbox#vim#begin_plugin(name)
    call s:checkPluginIsLoadedOnce(a:name)

    call php_refactoring_toolbox#vim#begin_script()
endfunction

function php_refactoring_toolbox#vim#end_plugin()
    call php_refactoring_toolbox#vim#end_script()
endfunction

function php_refactoring_toolbox#vim#begin_script()
    call s:configureCompatibilityOptions()
endfunction

function php_refactoring_toolbox#vim#end_script()
    call s:restoreCompatibilityOptions()
endfunction

function php_refactoring_toolbox#vim#appendFileTypeUndo(script)
...
function s:checkFileTypePluginIsLoadedOnce(name)
    ...
    call php_refactoring_toolbox#vim#appendFileTypeUndo('unlet! b:did_ftplugin_'.a:name)
endfunction
